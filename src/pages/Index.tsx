...
const checkItems = [
  "Почему блокировка счёта в строительстве — это почти всегда не внезапность, а предсказуемый финал. И кто обязан был это предсказать",
  "Какие именно показатели банк и ФНС отслеживают перед заморозкой — и почему ваш бухгалтер на них, скорее всего, не смотрит",
  "Как один крупный платёж субподрядчику без досье превратился в 4 дня простоя и 1,7 млн рублей потерь — разбор по шагам",
  "Что такое «реактивная бухгалтерия» и почему именно она — настоящий враг вашего бизнеса, а не налоговая и не банки",
  "Как выглядит бухгалтерия, которая работает на опережение: вы узнаёте о риске не от прораба, а получаете сообщение «угроза устранена, стройка идёт по плану»",
  "Конкретные шаги, которые позволили компании за 11 месяцев выйти на ноль блокировок и сэкономить 940 000 рублей на НДС",
];
    ...
    <div className="min-h-screen bg-white font-golos text-gray-900">
      <div className="max-w-[600px] mx-auto px-4 py-8 space-y-8">
        ...
        <section className="space-y-5">
          <div className="inline-block bg-brand-red-light border border-red-200 rounded-md px-3 py-1.5">
            <span className="text-brand-red text-[11px] font-semibold tracking-widest uppercase">
              Для владельцев строительных компаний с оборотом от 100 млн рублей
            </span>
          </div>

          <h1 className="text-[26px] sm:text-[32px] font-black leading-tight tracking-tight">
            Как мы спасли стройку от налоговой блокировки —{" "}
            <span className="text-brand-red">реальный кейс с цифрами</span>
          </h1>

          <p className="text-[15px] text-gray-500 leading-relaxed">
            Один платёж субподрядчику без правильного обоснования — и счёт заморожен на 4 дня. Потери: 1,7 млн рублей. Разбираем, что пошло не так и как это предотвратить.
          </p>
        ...
        <section className="border-l-4 border-brand-red bg-gray-50 rounded-r-xl px-5 py-5">
          <h3 className="text-[15px] font-bold mb-2">Это не продающий звонок и не курс</h3>
          <p className="text-[14px] text-gray-600 leading-relaxed">
            Кейс — это реальная история клиента с цифрами, ошибками и конкретными решениями. Никаких обязательств. Просто материал, который поможет вам увидеть, где в вашем бизнесе могут быть скрытые риски прямо сейчас.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-center text-[12px] text-gray-400 italic leading-relaxed pt-1">
            P.S. Материал подготовлен специально для строительных компаний с оборотом от 100 млн. Если у вас меньше — он, честно говоря, не для вас.
          </p>
        </section>
